...
export default async function DashboardLayout({
  ...
  return (
    <div className="fixed grid grid-cols-1 grid-rows-[3rem_1fr_4rem] md:grid-cols-[4rem_1fr] md:grid-rows-[4rem_1fr] max-h-screen w-screen px-2 md:pl-0 bg-background">
