...
export default async function DashboardLayout({
  ...
  return (
    <div className="fixed grid max-h-screen w-screen grid-cols-1 grid-rows-[3rem_1fr_4rem] bg-background px-2 md:grid-cols-[4rem_1fr] md:grid-rows-[5rem_1fr] md:pl-0">
