...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Action
    ref={ref}
    className={cn(
      'inline-flex h-8 shrink-0 items-center justify-center rounded-md border bg-transparent px-3 text-sm font-medium ring-offset-background transition-colors hover:bg-secondary focus:outline-hidden focus:ring-2 focus:ring-ring focus:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 group-[.destructive]:border-muted/40 group-[.success]:border-muted/40 hover:group-[.destructive]:border-destructive/30 hover:group-[.success]:border-success/30 hover:group-[.destructive]:bg-destructive hover:group-[.success]:bg-success hover:group-[.destructive]:text-destructive-foreground hover:group-[.success]:text-success-foreground focus:group-[.destructive]:ring-destructive focus:group-[.success]:ring-success',
      className
    )}
    {...props}
  />
