...
// Inlined public/logo/vethealth-logo.svg — rendered directly so the header
// logo paints without an extra request (it's an LCP candidate on most pages).
export default function Logo({ className }: { className?: string }) {
	return (
		<svg
			xmlns="http://www.w3.org/2000/svg"
			viewBox="0 0 1233 335"
			role="img"
			aria-label="Vethealth"
		...
		>
			<defs>
				...
				>
					<stop offset=".2" stopColor="#ff7b16" />
					<stop offset=".34" stopColor="#ff831b" />
					<stop offset=".55" stopColor="#ff9a28" />
					<stop offset=".81" stopColor="#ffbe3e" />
					<stop offset=".94" stopColor="#ffd34a" />
				</linearGradient>
				<linearGradient
					id="vh-logo-g2"
					x1="-3629.58"
					...
					x2="-3634.7"
					y2="-16.97"
					gradientTransform="matrix(-1 0 0 1 -3577.99 0)"
					href="#vh-logo-g1"
				/>
				<linearGradient
					id="vh-logo-g3"
